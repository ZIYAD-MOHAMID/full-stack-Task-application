...
import { CheckCircleIcon, ClockIcon, TagIcon, UserIcon } from "lucide-react";
      ...
      <div className="flex-1 bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-12">
        <div className="max-w-lg text-white">
          ...
          <p className="text-xl mb-8 text-blue-100">
            A powerful todo app built with modern technologies. Organize your
            tasks, set priorities, and track your progress with ease.
          </p>

          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-blue-200" />
              <span className="text-blue-100">Create and organize todos</span>
            </div>
            <div className="flex items-center space-x-3">
              <TagIcon className="h-6 w-6 text-blue-200" />
              <span className="text-blue-100">
                Categorize with tags and colors
              </span>
            </div>
            <div className="flex items-center space-x-3">
